...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35083 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35083(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35099 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35099(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35101 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35101(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35109 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35109(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35110 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35110(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35119 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35119(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35071,callback){
var map__35075 = p__35071;
var map__35075__$1 = cljs.core.__destructure_map(map__35075);
var input = map__35075__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35075__$1,new cljs.core.Keyword(null,"code","code",1586293142));
