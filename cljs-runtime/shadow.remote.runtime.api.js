...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34651 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34651(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34652 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_34652(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34654 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34654(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34656 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34656(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34657 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34657(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34659 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34659(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34641,callback){
var map__34642 = p__34641;
var map__34642__$1 = cljs.core.__destructure_map(map__34642);
var input = map__34642__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34642__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34642__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
