...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28944 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28944(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_28948 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_28948(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_28952 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_28952(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_28953 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_28953(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28960 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28960(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28963 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28963(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__28931,callback){
var map__28932 = p__28931;
var map__28932__$1 = cljs.core.__destructure_map(map__28932);
var input = map__28932__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28932__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28932__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
