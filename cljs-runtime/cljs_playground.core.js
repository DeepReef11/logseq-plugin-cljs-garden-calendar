...
return logseq.Editor.getCurrentBlock().then((function (p1__39662_SHARP_){
console.log("3");

cljs_playground.core.result = p1__39662_SHARP_;

console.log(cljs_playground.core.result);

cljs_playground.core.block_uuid = (function (){var target_obj_39663 = cljs_playground.core.result;
var _STAR_runtime_state_STAR__orig_val__39665 = oops.state._STAR_runtime_state_STAR_;
var _STAR_runtime_state_STAR__temp_val__39666 = oops.state.prepare_state(target_obj_39663,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});
(oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__temp_val__39666);

try{var next_obj_39664 = ((oops.core.validate_object_access_dynamically(target_obj_39663,(0),"uuid",true,true,false))?(target_obj_39663["uuid"]):null);
return next_obj_39664;
}finally {(oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__orig_val__39665);
}})();
...
var G__39667 = "create-garden-calendar";
var G__39668 = (function (){
...
return (cljs_playground.core.regSlashCmd.cljs$core$IFn$_invoke$arity$2 ? cljs_playground.core.regSlashCmd.cljs$core$IFn$_invoke$arity$2(G__39667,G__39668) : cljs_playground.core.regSlashCmd.call(null,G__39667,G__39668));
});
