...
var G__36297 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__36297) : datascript.lru.cleanup_lru.call(null,G__36297));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__36301 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36301,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36301,(1),null);
...
var datascript$lru$ICache$_get$dyn_36376 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_36376(this$,key,compute_fn);
}
});

datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
if((typeof datascript !== 'undefined') && (typeof datascript.lru !== 'undefined') && (typeof datascript.lru.t_datascript$lru36361 !== 'undefined')){
} else {
...
*/
datascript.lru.t_datascript$lru36361 = (function (limit,_STAR_impl,meta36362){
this.limit = limit;
...
(datascript.lru.t_datascript$lru36361.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36363,meta36362__$1){
var self__ = this;
var _36363__$1 = this;
return (new datascript.lru.t_datascript$lru36361(self__.limit,self__._STAR_impl,meta36362__$1));
}));

(datascript.lru.t_datascript$lru36361.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36363){
var self__ = this;
var _36363__$1 = this;
return self__.meta36362;
}));

(datascript.lru.t_datascript$lru36361.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru36361.prototype.datascript$lru$ICache$_get$arity$3 = (function (this$,key,compute_fn){
var self__ = this;
var this$__$1 = this;
...
(datascript.lru.t_datascript$lru36361.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta36362","meta36362",1854340596,null)], null);
}));

(datascript.lru.t_datascript$lru36361.cljs$lang$type = true);

(datascript.lru.t_datascript$lru36361.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru36361");

(datascript.lru.t_datascript$lru36361.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"datascript.lru/t_datascript$lru36361");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru36361.
 */
datascript.lru.__GT_t_datascript$lru36361 = (function datascript$lru$cache_$___GT_t_datascript$lru36361(limit__$1,_STAR_impl__$1,meta36362){
return (new datascript.lru.t_datascript$lru36361(limit__$1,_STAR_impl__$1,meta36362));
});

}

return (new datascript.lru.t_datascript$lru36361(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
