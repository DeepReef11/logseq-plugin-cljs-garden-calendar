...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26848 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26848(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26851 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26851(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26860 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26860(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26867 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26867(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26871 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26871(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26875 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26875(reader);
}
});
...
var G__26993 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26994 = s.append(c);
c = G__26993;
s = G__26994;
continue;
}
