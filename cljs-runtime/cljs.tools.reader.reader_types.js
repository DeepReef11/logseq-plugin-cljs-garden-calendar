...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26827 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26827(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26835 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26835(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26839 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26839(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26844 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26844(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26847 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26847(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26856 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26856(reader);
}
});
...
var G__26932 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26933 = s.append(c);
c = G__26932;
s = G__26933;
continue;
}
