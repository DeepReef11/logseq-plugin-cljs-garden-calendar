...
var G__49181 = o;
reagent.impl.template.goog$module$goog$object.set(G__49181,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__49313__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__49313 = function (var_args){
var args = null;
...
return G__49313__delegate.call(this,args);};
G__49313.cljs$lang$maxFixedArity = 0;
G__49313.cljs$lang$applyTo = (function (arglist__49315){
var args = cljs.core.seq(arglist__49315);
return G__49313__delegate(args);
});
G__49313.cljs$core$IFn$_invoke$arity$variadic = G__49313__delegate;
return G__49313;
})()
;
} else {
...
var G__49197 = o;
reagent.impl.template.goog$module$goog$object.set(G__49197,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__49316__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__49317__i < G__49317__a.length) {G__49317__a[G__49317__i] = arguments[G__49317__i + 0]; ++G__49317__i;}
  args = new cljs.core.IndexedSeq(G__49317__a,0,null);
} 
return G__49316__delegate.call(this,args);};
G__49316.cljs$lang$maxFixedArity = 0;
G__49316.cljs$lang$applyTo = (function (arglist__49318){
var args = cljs.core.seq(arglist__49318);
return G__49316__delegate(args);
});
...
var G__49214 = props;
var G__49214__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49214,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__49214);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49214__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__49226 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49226,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__49226;
}
})(),id_class);
...
var G__49229 = (cljs.core.count(argv) - first_child);
switch (G__49229) {
case (0):
...
var vec__49242 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49242,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49242,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49242,(2),null);
...
var temp__5757__auto___49324 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49324 == null)){
} else {
var key_49325 = temp__5757__auto___49324;
(jsprops.key = key_49325);
}
...
var temp__5757__auto___49326 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49326 == null)){
} else {
var key_49327 = temp__5757__auto___49326;
(jsprops.key = key_49327);
}
...
var temp__5757__auto___49329 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___49329 == null)){
} else {
var key_49330 = temp__5757__auto___49329;
(jsprops.key = key_49330);
}
...
var temp__5757__auto___49337 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49337 == null)){
} else {
var key_49338 = temp__5757__auto___49337;
(jsprops.key = key_49338);
}
...
var temp__5757__auto___49339 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49339 == null)){
} else {
var key_49340 = temp__5757__auto___49339;
(jsprops.key = key_49340);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49272_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__49272_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__49277 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49277,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49277,(1),null);
...
break;
default:
var G__49355 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__49356 = compiler;
v = G__49355;
compiler = G__49356;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template49310 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template49310 = (function (opts,id,fn_to_element,parse_fn,meta49311){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template49310.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49312,meta49311__$1){
var self__ = this;
var _49312__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template49310(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta49311__$1));
}));

(reagent.impl.template.t_reagent$impl$template49310.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49312){
var self__ = this;
var _49312__$1 = this;
return self__.meta49311;
}));

(reagent.impl.template.t_reagent$impl$template49310.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template49310.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template49310.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template49310.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template49310.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template49310.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta49311","meta49311",-1800345887,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template49310.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template49310.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template49310");

(reagent.impl.template.t_reagent$impl$template49310.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template49310");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template49310.
 */
reagent.impl.template.__GT_t_reagent$impl$template49310 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template49310(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49311){
return (new reagent.impl.template.t_reagent$impl$template49310(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49311));
});

}

return (new reagent.impl.template.t_reagent$impl$template49310(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
