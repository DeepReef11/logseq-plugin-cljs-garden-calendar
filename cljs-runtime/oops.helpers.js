...
var and__4251__auto____$1 = (!(oops.helpers.is_prototype_QMARK_(f)));
...
var G__36547 = cljs.core.next(items);
items = G__36547;
continue;
} else {
return arr;
...
var x36492 = error;
(x36492.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x36492.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__36556 = Object.getPrototypeOf(o);
o = G__36556;
continue;
} else {
...
var or__4253__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5757__auto__ = (goog.global["devtools"]);
