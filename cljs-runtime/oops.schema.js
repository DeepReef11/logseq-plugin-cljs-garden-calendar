...
var G__36678 = cljs.core.first(element_str);
switch (G__36678) {
case "?":
arr.push((1));
...
var G__36960 = cljs.core.next(items);
items = G__36960;
continue;
} else {
return null;
...
var G__36974 = cljs.core.next(items);
items = G__36974;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__36878 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__36878) : is_valid_QMARK_.call(null,G__36878));
})())){
var G__37002 = cljs.core.next(cljs.core.next(items));
items = G__37002;
continue;
} else {
return true;
...
switch (G__36906) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__36887_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__36887_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__36892_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__36892_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36906)].join('')));
