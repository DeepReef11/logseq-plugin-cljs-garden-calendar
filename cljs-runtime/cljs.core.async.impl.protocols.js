...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26513 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26513(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26520 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26520(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26525 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26525(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26526 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26526(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26530 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26530(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26541 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26541(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26544 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26544(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26545 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26545(b);
}
});
