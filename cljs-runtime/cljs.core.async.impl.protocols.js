...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32306 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32306(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32311 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32311(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32317 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32317(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32322 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32322(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32333 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32333(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32343 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32343(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_32357 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_32357(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32370 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32370(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32377 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32377(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32383 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32383(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32394 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32394(b);
}
});
