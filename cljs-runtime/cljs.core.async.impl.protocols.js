...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26178 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26178(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26183 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26183(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26185 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26185(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26187 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26187(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26188 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26188(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26192 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26192(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26196 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26196(h);
}
});
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26200(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26206 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26206(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26211 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26211(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26212 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26212(b);
}
});
