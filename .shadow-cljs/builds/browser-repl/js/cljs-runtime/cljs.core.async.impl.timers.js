...
var i_35120 = (0);
while(true){
if((i_35120 < arr.length)){
(arr[i_35120] = null);

var G__35122 = (i_35120 + (1));
i_35120 = G__35122;
continue;
} else {
}
...
var i_35136 = (self__.level + (1));
while(true){
if((i_35136 <= (new_level + (1)))){
(update[i_35136] = self__.header);

var G__35141 = (i_35136 + (1));
i_35136 = G__35141;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_35142 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_35142[i]));
} else {
x__$2.forward.push((((i < links_35142.length))?(links_35142[i]):null));
}

if((i < links_35142.length)){
(links_35142[i] = x__$2);
} else {
links_35142.push(x__$2);
}
...
var i_35152 = (0);
while(true){
if((i_35152 <= self__.level)){
var links_35157 = (update[i_35152]).forward;
if((x__$1 === (((i_35152 < links_35157.length))?(links_35157[i_35152]):null))){
(links_35157[i_35152] = (x__$1.forward[i_35152]));

var G__35160 = (i_35152 + (1));
i_35152 = G__35160;
continue;
} else {
var G__35161 = (i_35152 + (1));
i_35152 = G__35161;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__35170 = nx;
var G__35171 = (level__$1 - (1));
x = G__35170;
level__$1 = G__35171;
continue;
} else {
var G__35172 = x;
var G__35173 = (level__$1 - (1));
x = G__35172;
level__$1 = G__35173;
continue;
}
