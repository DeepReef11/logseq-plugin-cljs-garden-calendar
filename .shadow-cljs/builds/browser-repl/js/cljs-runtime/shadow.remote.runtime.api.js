...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34998 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34998(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35006 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35006(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35010 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35010(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35034 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35034(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35042 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35042(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35045 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35045(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34986,callback){
var map__34988 = p__34986;
var map__34988__$1 = cljs.core.__destructure_map(map__34988);
var input = map__34988__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34988__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34988__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
